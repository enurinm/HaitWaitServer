...
CREATE TABLE `queue` (
  ...
  KEY `sid` (`sid`),
  KEY `cid` (`cid`),
  CONSTRAINT `queue_ibfk_1` FOREIGN KEY (`sid`) REFERENCES `store` (`id`),
  CONSTRAINT `queue_ibfk_2` FOREIGN KEY (`cid`) REFERENCES `client` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'hate_wait'
--
